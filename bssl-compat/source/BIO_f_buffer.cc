...
static const BIO_METHOD *BIO_f_buffer_create(void) {
  ...
  static const BIO_METHOD bsslMethod = {
      ...
      //ossl.ossl_BIO_meth_get_callback_ctrl(osslMethod),
...
extern "C" const BIO_METHOD *BIO_f_buffer() {
   // bssl_compat_info("[+]BIO_METHOD::BIO_f_buffer");
   static const BIO_METHOD *result = BIO_f_buffer_create();
   return result;
}